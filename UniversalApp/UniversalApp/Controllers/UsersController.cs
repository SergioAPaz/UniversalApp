...
namespace UniversalApp.Controllers
{
    public class UsersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id,CreationDate,FirstName,LastName,Role,UserName,Comments,Password")] User user)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,CreationDate,FirstName,LastName,Role,UserName,Comments,Password")] User user)
        {
            if (ModelState.IsValid)
            {
